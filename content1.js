...
lib.ssMetadata = [
		{name:"content1_atlas_1", frames: [[0,0,307,230]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2088,746);


(lib.image1 = function() {
	this.initialize(ss["content1_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(-3.9,-3.5,695,248.3);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["content1_atlas_1"],0);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(1.2,0,0,1.2,-184.2,-138)).s().p("A8xVkMAAAgrHMA5jAAAMAAAArHg")
	}.bind(this);
	this.shape.setTransform(371.55,304.85);
...
p.nominalBounds = new cjs.Rectangle(187.4,166.9,368.4,276);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(285.1,146.2,1.5021,1.5021);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_2
	this.instance_1 = new lib.shape3("synched",0);
	this.instance_1.setTransform(1124.05,395.4,3.7553,3.7553);
	...
	this.instance_2.setTransform(210,0,1.5021,1.5021);
...
p.nominalBounds = new cjs.Rectangle(1079.2,245,752.8,651);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/content1_atlas_1.png", id:"content1_atlas_1"}
	],
	preloads: []
};
