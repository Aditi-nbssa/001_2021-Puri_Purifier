...
lib.ssMetadata = [
		{name:"topmenu_main_atlas_1", frames: [[0,0,661,92],[663,0,158,71]]}
];
...
(lib.CachedBmp_15 = function() {
	this.initialize(ss["topmenu_main_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,330.2,46);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#3366CC").s().p("Eh8/ABkIAAjHMD5/AAAIAADHg");
	this.shape.setTransform(800,55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00CCFF").s().p("Eh8/ABkIAAjHMD5/AAAIAADHg");
	this.shape_1.setTransform(800,80);
...
p.nominalBounds = new cjs.Rectangle(0,45,1600,45);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(24.95,2.95,0.4997,0.4997);
...
// stage content:
(lib.topmenu_main = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.btn8.name = "btn8";
	this.btn8.setTransform(5,47,0.9998,1.0005);
	new cjs.ButtonHelper(this.btn8, 0, 1, 2, false, new lib.button8(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn8).wait(2));
	...
	this.instance_1.setTransform(0,0,1,1.0011);
...
p.nominalBounds = new cjs.Rectangle(800,50,800,40);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/topmenu_main_atlas_1.png", id:"topmenu_main_atlas_1"}
	],
	preloads: []
};
